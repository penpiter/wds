...
if($Chek) {Send-MailMessage -From escheodinryukzak@gmail.com -Subject $ID" boot Windows SOS PiterPen" -To penpite@gmail.com -Body $MailBody -Credential (New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList "escheodinryukzak@gmail.com", (ConvertTo-SecureString -String "esc123ryu" -AsPlainText -Force)) -UseSsl -Port 587 -SmtpServer smtp.gmail.com}
